...
def save_cohort():
    """Save research_metrics.json files from the full 187-task benchmark to organized directories"""
    try:
        import shutil
        import glob
        import json
        
        # Full benchmark task set (all tasks with -mcp-container.json configs)
        COHORT_TASKS = [
            21, 22, 23, 24, 25, 26,
            47, 48, 49, 50, 51,
            96,
